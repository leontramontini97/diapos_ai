...
- **IDIOMA:** Todas las explicaciones deben estar en **{language}**, pero mantén absolutamente todas las **palabras técnicas**, términos y conceptos pertenecientes al tema en su **idioma original** (inglés, alemán, etc.) para facilitar el aprendizaje de vocabulario técnico.

INSTRUCCIONES
1) Explica el tema principal y por qué es relevante.
2) **EXPLICACIÓN DIDÁCTICA:** Divide la explicación completa en **puntos clave detallados y profundos** (no un párrafo largo). Cada punto debe ser **súper completo, técnico y profesional**, cubriendo TODOS los detalles visibles en la diapositiva sin omitir absolutamente nada. Aclara detalladamente cada término técnico que uses en el texto. Explica conceptos complejos de manera que un principiante pueda entenderlos desde cero, pero con rigor técnico suficiente para convertir al lector en un experto absoluto que domine los conceptos y pueda usar términos técnicos correctamente. Incluye definiciones, ejemplos prácticos, analogías cuando ayuden, y conexiones lógicas. Mantén absolutamente todos los términos técnicos o relacionados con el área en el idioma original de las diapositivas, explicándolos en {language} pero mezclándolo con el idioma original para nombrar todos los conceptos. Proporciona el contenido directo sin prefijos como "Punto 1:", "Punto 2:", etc. Si hay fórmulas, operaciones o unidades por favor usa el formato OneNote plaintext format para expresarlas. 
